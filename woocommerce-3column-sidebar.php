                ...
                <div class="row">
                    <div class="main-content col-md-9 col-sm-9 col-xs-12 pull-right">
                        ...
                        <div class="products-tools">
                            ...
                            <ul class="grid-list">
                                <li><a class="active" href="#" data-layout="grid" data-remove="lists" title="Grid view"><i class="icon_grid-2x2"></i></a></li>
                                <li><a href="#" data-layout="lists" data-remove="grid" title="List view"><i class="icon_menu"></i></a></li>
                            </ul>
