(function($){
    ...
    function init_wc_filter(){
        ...
        $('#cruxstore-shop-filters-content').on('click', '.widget-title', function(){
    ...
    */
    ...
    function init_wc_filters( ){
        ...
        $('#cruxstore-shop-filters').on('click', '.widget_cruxstore_orderby a, .widget_cruxstore_price_filter a, .widget_color_filter a, .widget_layered_nav a', function( e ){
            e.preventDefault();
            var $this = $(this),
