...
if ( is_plugin_active( 'contact-form-7/wp-contact-form-7.php' ) || defined( 'WPCF7_PLUGIN' ) ) {
    ...
    class WPBakeryShortCode_CruxStore_Contact_Form7 extends WPBakeryShortCode {
        protected function content($atts, $content = null) {
            ...
            $elementClass = array(
                'base' => apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'cruxstore-contact-form7', $this->settings['base'], $atts ),
    ...
    vc_map( array(
        "base" => "cruxstore_contact_form7",
        'name' => esc_html__( 'KT: Contact Form 7', 'cruxstore' ),
        ...
        'params' => array(
            ...
            array(
                'type' => 'dropdown',
                'heading' => esc_html__( 'Contact Form7 Layout', 'cruxstore' ),
                'param_name' => 'layout',
                'value' => array(
