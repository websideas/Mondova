...
class WPBakeryShortCode_CruxStore_List extends WPBakeryShortCode {
    protected function content($atts, $content = null) {
        ...
        $elementClass = array(
            'base' => apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'cruxstore-list ', $this->settings['base'], $atts ),
...
vc_map( array(
    "name" => esc_html__( "KT: Fancy List", 'cruxstore'),
    "base" => "cruxstore_list",
    ...
    "params" => array(
        ...
        array(
            'type' => 'dropdown',
            'heading' => esc_html__( 'List style', 'cruxstore' ),
            'param_name' => 'style',
            'value' => array(
                esc_html__( 'Check', 'cruxstore' ) => 'check',
                esc_html__( 'Numbers', 'cruxstore' ) => 'numbers',
                esc_html__( 'Angle Right ', 'cruxstore' ) => 'angle-right',
                esc_html__( 'Dot', 'cruxstore' ) => 'dot',
            ),
            'std' => 'check',
        ...
        array(
            ...
            'value' => array_merge( array( esc_html__( 'Accent color', 'cruxstore' ) => 'accent' ), getVcShared( 'colors' ), array( esc_html__( 'Custom color', 'js_composer' ) => 'custom' ) ),
            'std' => 'grey',
