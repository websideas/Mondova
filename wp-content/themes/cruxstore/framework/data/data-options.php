                ...
                'fields'        => array(
                    ...
                    array(
                        ...
                        'output'      => array(
                            ...
                            '#nav #main-nav-tool > li ul.sub-menu-dropdown',
                            '#nav #main-nav-tool > li .navigation-submenu',
                            '#nav #main-navigation > li ul.sub-menu-dropdown',
                            '#nav #main-navigation > li .cruxstore-megamenu-wrapper',
                    ...
                    array(
                        ...
                        'type'     => 'color',
                        'output'   => array(
                            '#nav #main-navigation > li .cruxstore-megamenu-wrapper > ul > li > a',
                            '#nav #main-navigation > li .cruxstore-megamenu-wrapper > ul > li > span',
                            '#nav #main-navigation > li .cruxstore-megamenu-wrapper > ul > li .widget-title',
                        ),
                    ...
                    array(
                        ...
                        'type'     => 'color',
                        'output'   => array(
                            '#nav #main-navigation > li .cruxstore-megamenu-wrapper > ul > li > a:hover'
                        ),
                    ...
                    array(
                        ...
                        'type'     => 'color',
                        'output'   => array(
                            '#nav #main-navigation > li > .cruxstore-megamenu-wrapper > .cruxstore-megamenu-ul > li ul.sub-menu-megamenu a'
                        ),
                    ...
                    array(
                        ...
                        'type'     => 'color',
                        'output'   => array(
                            '#nav #main-navigation > li > .cruxstore-megamenu-wrapper > .cruxstore-megamenu-ul > li ul.sub-menu-megamenu a:hover',
                            '#nav #main-navigation > li > .cruxstore-megamenu-wrapper > .cruxstore-megamenu-ul > li ul.sub-menu-megamenu .current-menu-item > a',
