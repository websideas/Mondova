...
if ( function_exists('register_sidebar')) {
    ...
    function cruxstore_register_sidebars(){
        ...
        register_sidebar( array(
            ...
            'id' => 'footer-top',
            'description' => esc_html__( 'The footer top widget area', 'cruxstore'),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget' => '</section>',
        ...
        register_sidebar(array(
            ...
            'before_title' => '<h3 class="widget-title"><span>',
            'after_title' => '</span></h3>',
            'description' => esc_html__('Use the Instagram widget here. IMPORTANT: For best result select "Small" under "Photo Size" and set number of photos to 5.', 'cruxstore'),
        ));
        ...
        register_sidebar( array(
            'name' => esc_html__( 'Footer bottom column 1', 'cruxstore'),
            'id' => 'footer-bottom-1',
            'description' => esc_html__( 'The footer bottom widget area', 'cruxstore'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget' => '</div>',
            'before_title' => '<h3 class="widget-title"><span>',
            'after_title' => '</span></h3>',
        ...
        register_sidebar( array(
            'name' => esc_html__( 'Footer bottom column 2', 'cruxstore'),
            'id' => 'footer-bottom-2',
            'description' => esc_html__( 'The footer bottom widget area', 'cruxstore'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget' => '</div>',
        ...
        register_sidebar( array(
            'name' => esc_html__( 'Footer bottom column 3', 'cruxstore'),
            'id' => 'footer-bottom-3',
            'description' => esc_html__( 'The footer bottom widget area', 'cruxstore'),
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget' => '</div>',
